...
#         # Load and place avatar image at top-right corner
#         # avatar_img = Image.open("avatar.png").resize((180, 180))
#         # base_img.paste(avatar_img, (self.width - 230, 30))  # Top-right corner position
#         # Load and round the avatar image
# # Load and round the avatar image
# # Load and add rounded corners to the avatar image
#         avatar_img = Image.open("avatar.png").resize((180, 180))
#         mask = Image.new("L", avatar_img.size, 0)
#         draw = ImageDraw.Draw(mask)
#         corner_radius = 20  # Adjust this value for the desired corner roundness
...
#         # Generate and add QR code (phone number instead of portfolio link)
#         qr_img = self.create_qr_code("https://saisreesatya.vercel.app/")  # Use phone number for QR code
...
#     # Save card
#     output_path = "dev_card_with_phone_number.png"
#     card.save(output_path)
#     print(f"\nYour developer card has been saved as '{output_path}'")
